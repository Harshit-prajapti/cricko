...
const Carousel = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center md:py-12 px-4">
      ...
      <p className="mt-8 text-xl text-gray-800">
        <strong>{images[index].name.toUpperCase()}</strong>
      </p>
      <Link href={`/tournaments/create?sport=${images[index].name}`}>
      <Button className='mt-5 cursor-pointer hover:bg-amber-700'>CREATE</Button>
      </Link>
